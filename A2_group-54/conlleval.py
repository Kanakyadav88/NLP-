...
def split_tag(tag):
    """Split a tag into position and entity type."""
    if tag == "O":
        return tag, ""
    elif tag in ["B", "I"]:
        # For simple B/I tags without entity type, add a default entity type
        return tag, "ASPECT"  # "ASPECT" can be any entity type name you want
    else:
        # For regular BIO tags with entity type (B-TYPE, I-TYPE)
        return tag.split('-', 1)
